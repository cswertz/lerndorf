...
export const learningUnitsFetch = () => (dispatch) =>
  fetch('/api/learningUnits', {
    method: 'GET',
    headers: {
...
export const learningUnitsItemFetch = (id) => async (dispatch) => {
  await dispatch({
...
export const learningUnitsSuggestionsFetch = (term) => (dispatch) =>
  fetch(`/api/learningUnits/suggestion/${term}`, {
    method: 'GET',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
...
export const learningUnitsAdd = (data, history) => (dispatch) =>
  fetch('/api/learningUnits', {
    method: 'post',
    headers: {
      Accept: 'application/json',
...
export const learningUnitsDelete = (id) => (dispatch) =>
...
export const learningUnitsEdit = (id, languageId, data, history) => (dispatch) =>
  fetch(`/api/learningUnits/${id}`, {
    method: 'PATCH',
    headers: {
      Accept: 'application/json',
...
export const learningUnitsTaxonomiesFetch = () => async (dispatch) => {
  await dispatch({
